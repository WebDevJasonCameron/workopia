    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full">
      ...
      <form 
        ...
        <x-inputs.text 
          ...
          <button 
            type="submit"
            class="w-full bg-green-500 text-white hover:bg-green-600 px-4 py-2 border rounded focus:outline-none">
            Save
          </button>
      </form>
    </div>
      ...
      @forelse($jobs as $job)
        <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
          ...
          <div class="flex space-x-3">
            ...
            <!-- Delete (different than the other delete)-->
            <form 
              method="POST" action="{{ route('jobs.destroy', $job->id) }}?from=dashboard" 
